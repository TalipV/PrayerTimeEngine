...
public partial class DynamicPrayerTimeView : ContentView
{
    ...
    private Grid createUI()
    {
        ...
        addPrayerTimeUI(mainGrid, "Fajr", nameof(DynamicPrayerTimesDay.Fajr),
        ...
        addPrayerTimeUI(mainGrid, "Duha", nameof(DynamicPrayerTimesDay.Duha),
            startRowNo, startColumnNo: 3,
            subtime1Name: "Quarter", subtime1Binding: $"{nameof(DynamicPrayerTimesDay.Duha)}.{nameof(DuhaPrayerTime.QuarterOfDay)}");

        addPrayerTimeUI(mainGrid, "Dhuhr", nameof(DynamicPrayerTimesDay.Dhuhr),
            startRowNo + 4, startColumnNo: 0);

        addPrayerTimeUI(mainGrid, "Asr", nameof(DynamicPrayerTimesDay.Asr),
        ...
        addPrayerTimeUI(mainGrid, "Maghrib", nameof(DynamicPrayerTimesDay.Maghrib),
        ...
        addPrayerTimeUI(mainGrid, "Isha", nameof(DynamicPrayerTimesDay.Isha),
