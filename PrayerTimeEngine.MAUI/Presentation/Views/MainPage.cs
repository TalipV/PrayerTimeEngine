...
namespace PrayerTimeEngine.Presentation.Views
{
    public partial class MainPage : ContentPage
    {
            ...
            )
        {
            ...
            this._profileDisplayNameTextInfo.GestureRecognizers
                .Add(
                    new TapGestureRecognizer
                    {
        ...
        private Grid createUI()
        {
            ...
            var carouselView = new CarouselView
            {
                ...
                {
                    var prayerTimeView = new PrayerTimeView(_viewModel);
            ...
            carouselView.SetBinding(CarouselView.ItemsSourceProperty, new Binding(nameof(MainPageViewModel.ProfilesWithModel), mode: BindingMode.TwoWay));
