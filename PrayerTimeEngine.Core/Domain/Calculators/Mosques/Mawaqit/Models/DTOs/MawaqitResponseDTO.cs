using NodaTime;
using NodaTime.Text;
using PrayerTimeEngine.Core.Domain.Calculators.Mosques.Mawaqit.JsonConverters;
using PrayerTimeEngine.Core.Domain.Calculators.Mosques.Mawaqit.Models.Entities;
using System.Text.Json.Serialization;

namespace PrayerTimeEngine.Core.Domain.Calculators.Mosques.Mawaqit.Models.DTOs;
...
public class MawaqitResponseDTO
{
    ...
    {
        if (this.PrayerTimeDays.Count != 12 || this.IqamahTimeValuesForDays.Count != 12)
        {
        ...
        {
            // times per month
            Dictionary<string, List<string>> prayerTimeDaysItem = this.PrayerTimeDays.ElementAt(i);
            Dictionary<string, List<string>> iqamahTimeValuesForDaysItem = this.IqamahTimeValuesForDays.ElementAt(i);
